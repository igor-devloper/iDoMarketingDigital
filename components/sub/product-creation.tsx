  ...
  return (
    <>
      <DropdownMenu >
        ...
        <DropdownMenuContent className="w-auto sm:max-w-[700px] max-w-[300px] max-h-[600px] px-5 pb-5 mb-4 flex flex-col items-center justify-center bg-black text-white font-bold space-y-3">
          <DropdownMenuLabel className="flex items-center justify-center p-4 text-xl">Criação</DropdownMenuLabel>
          <DropdownMenuGroup>
